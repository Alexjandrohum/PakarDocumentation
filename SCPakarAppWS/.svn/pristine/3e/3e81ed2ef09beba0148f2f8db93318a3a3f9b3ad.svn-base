...
public class ErrorDTO implements Serializable {
    ...
    public String toString() {
        return "ErrorDTO{" + "errorSerie=" + errorSerie + ", errorCodigo=" + errorCodigo + ", errorSocio=" + errorSocio + ", errorBloqueoSocio=" + errorBloqueoSocio + ", errorActivado=" + errorActivado + ", errorIdCliente=" + errorIdCliente + ", exito=" + exito + ", reEmail=" + reEmail + ", nuevoCliente=" + nuevoCliente + ", existePassword=" + existePassword + '}';
    }
